        ...
        <div className="lg:col-span-2 bg-gradient-to-br from-emerald-500 to-teal-600 rounded-2xl p-6 text-white">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div className="bg-white/10 backdrop-blur rounded-xl p-4">
              ...
              <p className="text-xs text-emerald-100 mt-1">Take a photo of your machine or upload from gallery</p>
            </div>
            <div className="bg-white/10 backdrop-blur rounded-xl p-4">
              ...
              <p className="text-xs text-emerald-100 mt-1">Our AI identifies the machine and its specifications</p>
            </div>
            <div className="bg-white/10 backdrop-blur rounded-xl p-4">
              ...
              <p className="text-xs text-emerald-100 mt-1">View detailed carbon footprint analysis instantly</p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white dark:bg-gray-800 rounded-2xl p-6 border border-gray-200 dark:border-gray-700">
          ...
          <div className="space-y-3">
            <div className="flex items-start gap-3">
              ...
              <div>
                <p className="text-sm text-gray-700 dark:text-gray-300">AI Photo Analysis improved</p>
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                <p className="text-sm text-gray-700 dark:text-gray-300">New machine database added</p>
