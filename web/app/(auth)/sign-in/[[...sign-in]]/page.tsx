  ...
  return (
    <div className="relative min-h-screen flex">
      ...
      <div className="hidden lg:block lg:w-1/2 relative overflow-hidden">
        ...
        <div className="absolute inset-0 flex flex-col justify-center px-16 text-white">
          <h2 className="text-4xl font-bold mb-4 leading-tight">
            Tekrar Hos Geldiniz
            <br />
            <span className="text-emerald-400">CarbonCAM</span>
          </h2>
          <p className="text-lg text-white/70 max-w-md">
            Hesabiniza giris yaparak karbon ayak izi analizlerinize devam edin.
          </p>
        </div>
      </div>
      ...
      <div className="w-full lg:w-1/2 flex flex-col justify-center px-8 sm:px-16 lg:px-20 py-12 bg-white">
        ...
        {/* Header */}
        <div className="mb-8">
          <h1 className="text-2xl font-semibold text-slate-900 mb-2">Giris Yapin</h1>
          <p className="text-slate-500">Hesabiniza erisin</p>
        </div>
